...
function Room() {
  ...
  return (
    <div className='container-fluid'>
      ...
      <div className='controllers second-part'>

        <div>
          {isAudioMuted ?
            <i class="fa fa-microphone-slash icon" aria-hidden="true" onClick={toggleAudio}></i>
            :
            <i class="fa fa-microphone icon" aria-hidden="true" onClick={toggleAudio}></i>

          }

          {isVideoPaused ? <i class="fa-solid fa-video-slash icon" onClick={toggleVideo}></i>
            :
            <i class="fa-solid fa-video icon" onClick={toggleVideo}></i>
          }
        </div>
